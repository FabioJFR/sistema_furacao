...
REGISTO_RATE_LIMIT_MAX_ATTEMPTS = int(env("REGISTO_RATE_LIMIT_MAX_ATTEMPTS", "4"))
REGISTO_RATE_LIMIT_WINDOW_SECONDS = int(env("REGISTO_RATE_LIMIT_WINDOW_SECONDS", "3600"))
REGISTO_MIN_SUBMISSION_SECONDS = int(env("REGISTO_MIN_SUBMISSION_SECONDS", "3"))
