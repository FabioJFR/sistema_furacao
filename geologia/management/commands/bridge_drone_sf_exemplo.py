...
class Command(BaseCommand):
    help = "Arranca uma bridge local para o Drone S_F, com /health, /live, /frame.svg, heartbeat e consumo de comandos da plataforma."

    def add_arguments(self, parser):
        parser.add_argument("--config", default="", help="Ficheiro JSON de configuração da bridge S_F.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Bridge Drone S_F iniciada."))
