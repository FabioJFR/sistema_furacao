...
_AREAS_TODO = {
    ...
    "projetos": {
        ...
        "proximos_passos": [
            "[NOVA FASE · GESTAO EMPRESA] Evoluir `Clientes & Contratos` com anexos de contrato, adendas, renovação automática e alertas de vencimento.",
            "[NOVA FASE · GESTAO EMPRESA] Evoluir `Planeamento` com calendário visual (semanal/mensal), deteção automática de conflitos e capacidade por turno.",
            ...
            "[NOVA FASE · GESTAO EMPRESA] Evoluir `Compliance & Segurança` com checklists HSE, incidentes, auditorias e ações corretivas.",
            "[NOVA FASE · GESTAO EMPRESA] Evoluir `Centro de Notificações` com atribuição, SLA, histórico e envio automático.",
            "[NOVA FASE · GESTAO EMPRESA] Evoluir `Relatórios Executivos` com exportação PDF e envio agendado com histórico/auditoria avançada.",
