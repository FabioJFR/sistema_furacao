...
urlpatterns = [
    ...
    path("admin/configuracoes-perfuracao/<int:pk>/", views.configuracao_perfuracao_detail_admin, name="configuracao_perfuracao_detail_admin"),
    path("admin/configuracoes-perfuracao/<int:pk>/editar/", views.configuracao_perfuracao_update_admin, name="configuracao_perfuracao_update_admin"),
    path("admin/configuracoes-perfuracao/<int:pk>/apagar/", views.configuracao_perfuracao_delete_admin, name="configuracao_perfuracao_delete_admin"),
