...
class Empregados(models.Model):
    FUNCAO_GERAL_CHOICES = [
        ...
        ("ajudante_eletricista", "Ajudante de Eletricista"),
        ("serralheiro_mecanico", "Serralheiro Mecânico"),
        ("ajudante_serralheiro_mecanico", "Ajudante Serralheiro Mecânico"),
        ("contabilista", "Contabilista"),
        ("advogado", "Advogado"),
        ("secretario", "Secretária/o"),
        ("empregado_limpeza", "Empregado/a Limpeza"),
